...
resource "aws_iam_policy" "nodes_alb" {
...
resource "aws_iam_role_policy_attachment" "eks_worker_alb" {
  policy_arn = aws_iam_policy.nodes_alb.arn
  role       = aws_iam_role.nodes.name
}

resource "aws_iam_policy" "nodes_route53" {
...
resource "aws_iam_role_policy_attachment" "nodes_route53" {
  policy_arn = aws_iam_policy.nodes_route53.arn
  role       = aws_iam_role.nodes.name
}

resource "aws_iam_policy" "nodes_autoscaling" {
...
resource "aws_iam_role_policy_attachment" "nodes_autoscaling" {
  policy_arn = aws_iam_policy.nodes_autoscaling.arn
  role       = aws_iam_role.nodes.name
}
